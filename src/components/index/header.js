        ...
        <Container>
            <Row>
                <Col md='12' className='index-header-content'>
                    ...
                    <p>By day, I'm a web developer in the San Francisco Bay Area. By night, I'm still a web developer (who of course fancies the little things in life, like spending time with my Fiancé 👫 and <DnDmodal text='Dungeons &amp; Dragons 🎲' />).</p>
                </Col>
            </Row>
            <Row>
                <Col md='12' className='index-header-content'>
